const translations = {
  en: {
    ...
    heroTitle: "Get a deep company research summary starting from here.",
    heroDescription:
    ...
    formHint: "Results will appear below in a few seconds.",
